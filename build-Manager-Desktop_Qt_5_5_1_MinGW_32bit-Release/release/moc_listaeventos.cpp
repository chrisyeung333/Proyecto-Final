...
#include "../../Manager/listaeventos.h"
...
struct qt_meta_stringdata_ListaEventos_t {
    QByteArrayData data[3];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ListaEventos_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ListaEventos_t qt_meta_stringdata_ListaEventos = {
    {
QT_MOC_LITERAL(0, 0, 12), // "ListaEventos"
QT_MOC_LITERAL(1, 13, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "ListaEventos\0on_pushButton_clicked\0"
};
...
void ListaEventos::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ListaEventos *_t = static_cast<ListaEventos *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ListaEventos::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ListaEventos.data,
      qt_meta_data_ListaEventos,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ListaEventos::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ListaEventos.stringdata0))
