/****************************************************************************
** Meta object code from reading C++ file 'loginform2.h'
**
...
#include "../../Manager/loginform2.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'loginform2.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(2, 33, 0) // ""
    ...
    "LoginForm2\0on_pushButton_clicked\0"
};
...
void LoginForm2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LoginForm2 *_t = static_cast<LoginForm2 *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject LoginForm2::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_LoginForm2.data,
      qt_meta_data_LoginForm2,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LoginForm2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LoginForm2.stringdata0))
        return static_cast<void*>(const_cast< LoginForm2*>(this));
